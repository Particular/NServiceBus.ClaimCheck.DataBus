...
public class DataBusExtensions : ExposeSettings
{
    ...
    public DataBusExtensions AddDeserializer<TSerializer>(TSerializer serializer) where TSerializer : IDataBusSerializer
    {
        ...
        var deserializers = this.GetSettings().Get<List<IDataBusSerializer>>(Features.DataBusFeature.AdditionalDataBusDeserializersKey);
        ...
        var mainSerializer = this.GetSettings().Get<IDataBusSerializer>(Features.DataBusFeature.DataBusSerializerKey);
